...
$('.alladv').click(function() {
       ...
       ///========================================
        ...
        function showcat(id,title) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "Show/get_adv_by_parentid_json",
                data: ({
                    'id': id,
                    'city_id':$city_id
                }),
